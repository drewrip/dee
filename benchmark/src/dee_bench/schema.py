...
RUNS = Table(
    ...
    columns=[
        ...
        Column("subprocess_wall_ms", pa.int64(), "Wall time of the whole dee-cli invocation, divided across its repetitions. Includes startup; useful only as a sanity check against engine_wall_ms."),
        ...
        Column("peak_rss_bytes", pa.int64(), "Peak resident set size observed during this run, across the sampled process tree and container."),
...
DAG_GRAPH = Table(
    ...
    columns=[
        ...
        Column("paths_to_sinks", pa.int32(), "Distinct paths from this node to a sink; how many times its work is duplicated downstream."),
